...
const Sidebar = ({ unreadTicketsCount, displayUser, userProfile }) => {
  ...
  return (
    <aside className="w-72 h-screen fixed top-0 left-0 flex flex-col bg-[#0b0e14] border-r border-[#1e2330] z-50 overflow-visible">
      ...
      {/* Footer del Sidebar */}
      <div className="p-4 bg-[#0b0e14] border-t border-[#1e2330] flex flex-col gap-2">
        {/* Botón Telegram */}
        <a
          href="https://t.me/devmaxios"
          target="_blank"
          rel="noopener noreferrer"
          className="w-full flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-semibold transition-all duration-300 group"
          style={{
            background: 'linear-gradient(135deg, rgba(36,161,222,0.12) 0%, rgba(36,161,222,0.04) 100%)',
            border: '1px solid rgba(36,161,222,0.25)',
            color: '#24A1DE',
          }}
          onMouseEnter={e => {
            e.currentTarget.style.background = 'linear-gradient(135deg, rgba(36,161,222,0.22) 0%, rgba(36,161,222,0.10) 100%)';
            e.currentTarget.style.boxShadow = '0 0 18px rgba(36,161,222,0.25)';
            e.currentTarget.style.borderColor = 'rgba(36,161,222,0.55)';
          }}
          onMouseLeave={e => {
            e.currentTarget.style.background = 'linear-gradient(135deg, rgba(36,161,222,0.12) 0%, rgba(36,161,222,0.04) 100%)';
            e.currentTarget.style.boxShadow = 'none';
            e.currentTarget.style.borderColor = 'rgba(36,161,222,0.25)';
          }}
        >
          {/* Icono Telegram SVG oficial */}
