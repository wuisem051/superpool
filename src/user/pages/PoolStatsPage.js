...
const PoolStatsPage = () => {
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-[#0b0e14] flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-orange-400 font-mono tracking-widest text-sm">CONECTANDO CON LA RED...</p>
            </div>
        );
    }
    ...
    if (error && !stats) {
        return (
            <div className="min-h-screen bg-[#0b0e14] flex flex-col items-center justify-center gap-4">
                <p className="text-red-400 font-mono">Error de conexión a la red de minería.</p>
    ...
    const poolLuck = stats?.poolLuck ?? null;
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
                    <div>
                        ...
                        <p className="text-gray-400 mt-2 text-sm">Datos sincronizados en tiempo real con la red de minería.</p>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="bg-[#131824] border border-[#1e2330] rounded-xl px-4 py-2 flex items-center gap-3 text-xs text-gray-500 font-mono">
                            ...
                            <span>Actualizado: <span className="text-green-400">{timeAgo}</span></span>
                            <span>·</span>
                            <span>Refresca en <span className="text-orange-400">{countdown}s</span></span>
                        </div>
                        <button
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div className="col-span-2 md:col-span-4 md:flex hidden"></div>
                </div>

                {/* Stats Banner superiores (como en solopool) */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div className="bg-[#131824]/90 backdrop-blur p-5 rounded-2xl border border-[#1e2330] flex items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider">Pool Hashrate</p>
                        </div>
                    ...
                    <div className="bg-[#131824]/90 backdrop-blur p-5 rounded-2xl border border-[#1e2330] flex items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider">Miners Online</p>
                        </div>
                    ...
                    <div className="bg-[#131824]/90 backdrop-blur p-5 rounded-2xl border border-[#1e2330] flex items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider">Network Hashrate</p>
                        </div>
                    ...
                    <div className="bg-[#131824]/90 backdrop-blur p-5 rounded-2xl border border-[#1e2330] flex items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider">Network Difficulty</p>
                        </div>
                ...
                {/* Stats Banner inferiores (Height / Last Block / Total Blocks / Pool Luck) */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    <div className="bg-[#131824]/90 backdrop-blur p-5 rounded-2xl border border-[#1e2330] flex items-center justify-between gap-4">
                        <div>
                            <p className="text-2xl font-bold font-mono text-white">{formatNumber(height)}</p>
                            <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider">Height</p>
                        </div>
                    ...
                    <div className="bg-[#131824]/90 backdrop-blur p-5 rounded-2xl border border-[#1e2330] flex items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider">Last Block</p>
                        </div>
                    ...
                    <div className="bg-[#131824]/90 backdrop-blur p-5 rounded-2xl border border-[#1e2330] flex items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider">Total Blocks</p>
                        </div>
                    ...
                    <div className="bg-[#131824]/90 backdrop-blur p-5 rounded-2xl border border-[#1e2330] flex items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider">Workers Activos</p>
                        </div>
                ...
                <div className="bg-[#131824]/90 backdrop-blur p-6 md:p-8 rounded-3xl border border-[#1e2330] shadow-2xl mb-8">
                    <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                        <div>
                            <h3 className="text-xl font-bold text-white">Pool & Network Charts</h3>
                            <p className="text-gray-500 text-sm mt-1">Hashrate de la pool durante las últimas 24 horas.</p>
                        </div>
                        <div className="flex items-center gap-3 text-xs">
                            <span className="flex items-center gap-1.5 text-orange-400"><span className="w-3 h-0.5 bg-orange-400 rounded inline-block"></span>Pool Hashrate</span>
                        </div>
                    </div>
                    ...
                    {chartData.length > 0 ? (
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={chartData} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                                    ...
                                    <Tooltip
                                        ...
                                        formatter={(value, name, props) => [formatHashrate(props.payload.hashrateRaw), 'Hashrate']}
                                    />
                                    <Area
                                        type="monotone"
                        ...
                        <div className="h-[350px] flex items-center justify-center text-gray-500">Sin datos de gráfica disponibles.</div>
                    )}
                </div>
